...
const config = {
  ...
  organizationName: 'sberm', // Usually your GitHub org/user name.
  projectName: 'howard-chu-site', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/sberm/howard-chu-site',
        },
        blog: {
